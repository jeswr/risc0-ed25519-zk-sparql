...
use methods::{SPARQL_ED25519_ELF, SPARQL_ED25519_ID, EMPTY_ELF, QUERY_OBJECT_ELF, QUERY_STRING_ELF, ED25519_VERIFY_ELF};
...
fn preprocess_mode(args: &Args) {
    ...
    for verify_input in verify_inputs {
        ...
        let output = receipt.journal.decode::<bool>().unwrap();
